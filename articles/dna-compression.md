...
![_Figure 1_. Scatter plot showing speed of bit rotation (blue) and match arm (orange) in nanoseconds.](/assets/bitvsmatchcomplement.png){width=2044 height=1095}
...
![_Figure 2_. Scatter plot showing speed of bit rotation (blue) and match arm (orange) in milliseconds for [large _Drosophila Melanogaster_ nucleotide sequence](https://www.ncbi.nlm.nih.gov/nuccore/AE014297).](/assets/bitvsmatchcomplementAE014297.png){width=2044 height=1095}
